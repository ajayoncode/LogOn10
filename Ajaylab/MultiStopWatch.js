...
onoff_List[count]=false

watchList[count]='00:00:00'
...
timer(e){
      ...
      if(this.state.onoff_List[e]==true)
      {
            d1 = new Date();
         n1 = d1.getTime();
      }
      else
      {
        ...
        time_diff=parseInt(n2)-parseInt(n1)
        time_diff=this.msToTime(time_diff)
       this.setState({running:time_diff})
 ...
 <View style={{flex:1}}>
        ...
        <View>
          ...
          <Appbar.Header style={{backgroundColor:'grey'}}>
           <Appbar.Content title="Multi-Stopwatch" color="white" onPress={()=> alert('drawer')  } />
